<template>
    <div class="p-4 border-t flex items-center gap-2" v-if="ActiveUser">
        <input
        ...
        class=""
        >
        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" class="w-7 h-7"  viewBox="0 0 48 48">
...
export default {
    setup () {
        ...
        return { newMessage , sendMessage , ActiveUser }
    }
}
</script>
